...
* ``sudo apt install libasound2t64 libasound2-plugins alsa-utils alsa-tools alsa-firmware-loaders pipewire-audio pipewire pipewire-audio-client-libraries pipewire-pulse pipewire-alsa libcanberra-pulse pipewire wireplumber``
* ``systemctl --user restart wireplumber pipewire pipewire-pulse``

**Optional all dependencies for pipewire chose between jack and pipewire-jack**
